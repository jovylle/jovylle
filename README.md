...
<table align="center" style="border-collapse: collapse; width: 100%; max-width: 600px;">
  ...
  <tbody>
    <tr style="background: #ffffff;">
      ...
      <td style="padding: 12px; text-align: center; border: 1px solid #d0d7de; font-weight: bold; color: #dc3545; background: #e6ffed;">313ms</td>
    ...
    <tr style="background: #f6f8fa;">
      ...
      <td style="padding: 12px; text-align: left; border: 1px solid #d0d7de; font-weight: 500;">CoolBard999</td>
      <td style="padding: 12px; text-align: center; border: 1px solid #d0d7de; font-weight: bold; color: #dc3545; ">486ms</td>
      <td style="padding: 12px; text-align: center; border: 1px solid #d0d7de; font-size: 0.9em; color: #666;">7/31/2026</td>
    </tr>
    <tr style="background: #ffffff;">
